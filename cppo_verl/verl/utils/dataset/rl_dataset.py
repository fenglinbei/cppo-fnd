...
class RLHFDataset(Dataset):
    ...
    def _read_files_and_tokenize(self):
        ...
        if self.debug > 0:
            self.dataframe = self.dataframe.select(range(self.debug))
            print(f'debug dataset len: {len(self.dataframe)}')
    ...
    def __getitem__(self, item):
        ...
        if is_multi_modal:
            from cppo_verl.verl.models.transformers.qwen2_vl import get_rope_index
