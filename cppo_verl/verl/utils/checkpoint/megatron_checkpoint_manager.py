...
from cppo_verl.verl.utils.fs import copy_to_local, is_non_local
from cppo_verl.verl.models.weight_loader_registry import get_weight_saver
from cppo_verl.verl.models.weight_loader_registry import get_weight_loader
from cppo_verl.verl.utils.model import load_megatron_model_weights
from cppo_verl.verl.utils.megatron_utils import TransformerConfig, get_model_checkpoint_path, get_hf_model_checkpoint_path, get_optimizer_checkpoint_path, get_rng_states_checkpoint_path, unwrap_model
    ...
    def save_checkpoint(self, local_path: str, hdfs_path: str = None, global_step: int = 0, max_ckpt_to_keep=None):
        ...
        if 'model' in self.checkpoint_contents and mpu.get_data_parallel_rank() == 0:
            ...
            if hdfs_path is not None:
                ...
                from cppo_verl.verl.utils import hdfs_io
