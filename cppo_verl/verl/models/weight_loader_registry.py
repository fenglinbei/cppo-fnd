...
def get_weight_loader(arch: str):
    from cppo_verl.verl.models.llama.megatron.checkpoint_utils.llama_loader import load_state_dict_to_megatron_llama
    from cppo_verl.verl.models.qwen2.megatron.checkpoint_utils.qwen2_loader import load_state_dict_to_megatron_qwen2
    from cppo_verl.verl.models.mcore.loader import load_state_dict_to_megatron_gptmodel
...
def get_weight_saver(arch: str):
    from cppo_verl.verl.models.llama.megatron.checkpoint_utils.llama_saver import merge_megatron_ckpt_llama
    from cppo_verl.verl.models.qwen2.megatron.checkpoint_utils.qwen2_saver import merge_megatron_ckpt_qwen2
    from cppo_verl.verl.models.mcore.saver import merge_megatron_ckpt_gptmodel
