...
from cppo_verl.verl.protocol import DataProtoFuture
...
def _split_args_kwargs_data_proto(chunks, *args, **kwargs):
    from cppo_verl.verl.protocol import DataProto, DataProtoFuture
    splitted_args = []
    for arg in args:
...
def dispatch_megatron_compute(worker_group, *args, **kwargs):
    ...
    """
    from cppo_verl.verl.single_controller.base.megatron.worker_group import MegatronWorkerGroup
...
def _concat_data_proto_or_future(output: List):
    from cppo_verl.verl.protocol import DataProto, DataProtoFuture
    import cppo_verl.verl.single_controller.ray as ray
...
def collect_megatron_compute_data_proto(worker_group, output):
    ...
    """
    from cppo_verl.verl.protocol import DataProto
    import cppo_verl.verl.single_controller.ray as ray
...
def dispatch_dp_compute(worker_group, *args, **kwargs):
    from cppo_verl.verl.single_controller.base.worker_group import WorkerGroup
