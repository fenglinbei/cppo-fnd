...
from cppo_verl.verl.single_controller.base.megatron.worker import MegatronWorker
from cppo_verl.verl.workers.actor.megatron_actor import MegatronPPOActor
from cppo_verl.verl.workers.critic.megatron_critic import MegatronPPOCritic
from cppo_verl.verl.workers.sharding_manager import AllGatherPPModel
from cppo_verl.verl.workers.reward_model.megatron.reward_model import MegatronRewardModel
...
from cppo_verl.verl.utils.model import load_megatron_model_weights, load_megatron_gptmodel_weights
from cppo_verl.verl.utils.flops_counter import FlopsCounter
from cppo_verl.verl.utils.checkpoint.megatron_checkpoint_manager import MegatronCheckpointManager
from cppo_verl.verl.utils.megatron_utils import init_model_parallel_config
from cppo_verl.verl.utils.megatron_utils import offload_megatron_param_and_grad, load_megatron_param_and_grad
from cppo_verl.verl.utils import hf_tokenizer
...
class ActorRolloutRefWorker(MegatronWorker):
    ...
    def _build_model_optimizer(self,
        ...
        from cppo_verl.verl.utils.megatron.optimizer import get_megatron_optimizer
        from megatron.core.models.gpt.gpt_model import ModelType
        from cppo_verl.verl.utils.model import print_model_size, update_model_config, get_generation_config
        from cppo_verl.verl.utils.megatron_utils import get_model, init_megatron_optim_config, convert_config
        ...
        def megatron_actor_model_provider(pre_process, post_process):
            from cppo_verl.verl.utils.model import get_parallel_gptmodel_from_config
    ...
    def _build_rollout(self):
        if self.config.rollout.name == 'vllm':
            ...
            from cppo_verl.verl.workers.sharding_manager import MegatronVLLMShardingManager
            from cppo_verl.verl.utils.model import normalize_pp_vpp_params
...
class CriticWorker(MegatronWorker):
    ...
    def _build_critic_model_optimizer(self,
                                      ...
                                      enable_gradient_checkpointing=False):
        from megatron.core.models.gpt.gpt_model import ModelType
        from cppo_verl.verl.utils.model import print_model_size, update_model_config
        from cppo_verl.verl.utils.megatron.optimizer import get_megatron_optimizer
        from cppo_verl.verl.utils.megatron_utils import get_model, init_megatron_optim_config, init_model_parallel_config, convert_config
...
class RewardModelWorker(MegatronWorker):
    ...
    def _build_rm_model(self, model_path, megatron_config: ModelParallelConfig, override_model_config):
        from megatron.core.models.gpt.gpt_model import ModelType
        from cppo_verl.verl.utils.model import update_model_config
        from cppo_verl.verl.utils.megatron_utils import get_model
        from transformers import AutoConfig
        ...
        def megatron_rm_model_provider(pre_process, post_process):
            from cppo_verl.verl.utils.model import get_parallel_model_from_config
