...
import cppo_verl.verl.utils.torch_functional as verl_F
from omegaconf import DictConfig, open_dict
from cppo_verl.verl import DataProto
from cppo_verl.verl.single_controller.base import Worker
from cppo_verl.verl.single_controller.base.decorator import register, Dispatch
from cppo_verl.verl.utils import hf_tokenizer, hf_processor
from cppo_verl.verl.utils.debug import log_gpu_memory_usage
from cppo_verl.verl.utils.fs import copy_to_local
from cppo_verl.verl.utils.fsdp_utils import get_fsdp_wrap_policy, init_fn, get_init_weight_context_manager
from cppo_verl.verl.utils.fsdp_utils import offload_fsdp_optimizer, offload_fsdp_model_to_cpu, load_fsdp_optimizer, \
    load_fsdp_model_to_gpu
from cppo_verl.verl.utils.import_utils import import_external_libs
from cppo_verl.verl.utils.model import compute_position_id_with_mask
from cppo_verl.verl.utils.flops_counter import FlopsCounter
from cppo_verl.verl.utils.checkpoint.fsdp_checkpoint_manager import FSDPCheckpointManager
from cppo_verl.verl.workers.sharding_manager.fsdp_ulysses import FSDPUlyssesShardingManager
...
class ActorRolloutRefWorker(Worker):
    ...
    def _build_model_optimizer(self,
                               ...
                               use_liger=False,
                               role='actor'):
        from cppo_verl.verl.utils.model import print_model_size, update_model_config, get_generation_config
        from cppo_verl.verl.utils.torch_dtypes import PrecisionType
        ...
        with init_context(), warnings.catch_warnings():
            ...
            if use_remove_padding or self.ulysses_sequence_parallel_size > 1:
                from cppo_verl.verl.models.transformers.monkey_patch import apply_monkey_patch
        ...
        if role == 'actor' and optim_config is not None:
            from cppo_verl.verl.utils.torch_functional import get_constant_schedule_with_warmup, get_cosine_schedule_with_warmup
    ...
    def _build_rollout(self, trust_remote_code=False):
        ...
        if rollout_name == 'hf':
            from cppo_verl.verl.workers.rollout import HFRollout
            from cppo_verl.verl.workers.sharding_manager import BaseShardingManager
            rollout = HFRollout(module=self.actor_module_fsdp, config=self.config.rollout)
            rollout_sharding_manager = BaseShardingManager()
            # TODO: a sharding manager that do nothing?

        elif rollout_name == 'vllm':
            from cppo_verl.verl.workers.rollout.vllm_rollout import vLLMRollout, vllm_mode
            from cppo_verl.verl.workers.sharding_manager import FSDPVLLMShardingManager
            ...
            from cppo_verl.verl.workers.rollout.sglang_rollout import SGLangRollout
            ...
            from cppo_verl.verl.workers.sharding_manager.fsdp_sglang import FSDPSGLangShardingManager
            log_gpu_memory_usage(f'Before building {rollout_name} rollout', logger=None)
    ...
    def init_model(self):
        from cppo_verl.verl.workers.actor import DataParallelPPOActor
...
class CriticWorker(Worker):
    ...
    def _build_critic_model_optimizer(self, config):
        ...
        from cppo_verl.verl.utils.model import LambdaLayer, print_model_size, squeeze
        from cppo_verl.verl.utils.torch_dtypes import PrecisionType
    ...
    def init_model(self):
        ...
        from cppo_verl.verl.workers.critic import DataParallelPPOCritic
...
class RewardModelWorker(Worker):
    ...
    def _forward_micro_batch(self, micro_batch):
        ...
        from cppo_verl.verl.utils.ulysses import ulysses_pad_and_slice_inputs, gather_outpus_and_unpad
    ...
    def compute_rm_score(self, data: DataProto):
        import itertools
        from cppo_verl.verl.utils.seqlen_balancing import rearrange_micro_batches, get_reverse_idx
        # Support all hardwares
        data = data.to(torch.cuda.current_device())
