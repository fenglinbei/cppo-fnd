...
from cppo_verl.verl.utils.megatron_utils import get_model, unwrap_model
from cppo_verl.verl.utils.memory_buffer import (
    build_memory_buffer,
...
class AllGatherPPModel:
    ...
    def _build_param_buffer(self, pp_rank):
        ...
        if pp_rank == self._pp_rank:
            from cppo_verl.verl.utils.memory_buffer import MemoryBuffer
...
from cppo_verl.verl.utils.torch_functional import (broadcast_dict_tensor, allgather_dict_tensors)
import cppo_verl.verl.utils.megatron.tensor_parallel as tp_utils
from cppo_verl.verl.third_party.vllm import parallel_state as vllm_ps
from cppo_verl.verl.third_party.vllm import LLM
