...
from cppo_verl.verl.utils.megatron_utils import get_model_config
...
from cppo_verl.verl.utils.megatron.tensor_parallel import vocab_parallel_entropy, vocab_parallel_log_probs_from_logits
from cppo_verl.verl.utils.megatron.pipeline_parallel import (compute_transformers_input_shapes, make_batch_generator)
from cppo_verl.verl import DataProto
from cppo_verl.verl.trainer.ppo.core_algos import compute_policy_loss, kl_penalty, agg_loss
from cppo_verl.verl.workers.actor import BasePPOActor
from cppo_verl.verl.utils.py_functional import append_to_dict
from cppo_verl.verl.utils.torch_functional import logprobs_from_logits, masked_mean, broadcast_dict_tensor, split_dict_tensor_into_batches
...
class MegatronPPOActor(BasePPOActor):
    ...
    def forward_backward_batch(self, data: DataProto, forward_only=False, post_process_fn=None):
        ...
        def forward_step(batch_iter, model):
            ...
            from cppo_verl.verl.models.mcore import gptmodel_forward
