...
from src.open_r1.rewards_fnd import (
    ...
    factcheck_tag_count_reward,
    factcheck_label_reward,
    factcheck_ordinal_reward,
    factcheck_explanation_quality_reward,
    factcheck_grounding_reward,
    get_factcheck_cosine_scaled_reward,
...
def main(script_args, training_args, model_args):
    ...
    "fc_tag_count": factcheck_tag_count_reward,
    "fc_label": factcheck_label_reward,
    "fc_ordinal": factcheck_ordinal_reward,
    "fc_expl": factcheck_explanation_quality_reward,
    "fc_grounding": factcheck_grounding_reward,
    "fc_cosine": get_factcheck_cosine_scaled_reward(
        min_value_wrong=-0.3,
        max_value_wrong=0.0,
        min_value_correct=0.2,
        max_value_correct=0.5,
        max_len=training_args.max_completion_length,
    ),
