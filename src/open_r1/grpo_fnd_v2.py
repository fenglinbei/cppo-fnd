...
from src.open_r1.rewards_fnd_macro import (
...
from src.open_r1.grpo_trainer_fnd_macro import GRPOTrainer
...
def main(script_args, training_args, model_args):
    ...
    "fc_format": factcheck_format_reward,
    "fc_label": factcheck_label_reward,
    "fc_evidence": factcheck_evidence_usage_reward,
    "fc_grounding": factcheck_grounding_reward,
    "fc_expl": factcheck_explanation_quality_reward,
    "repetition_penalty": get_repetition_penalty_reward(3, -0.20),
}
    ...
    def make_conversation(example, training_args):
        ...
        user_content = (
            ...
            "In <evidence_used>, list only the evidence numbers you actually used.\n"
            "If none of the evidence is useful, output <evidence_used>none</evidence_used>.\n"
            "Output exactly the required tags and nothing else."
        )
    ...
    training_args.vllm_guided_decoding_regex = DEFAULT_GUIDED_DECODING_REGEX
